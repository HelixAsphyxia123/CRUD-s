...
public class B extends javax.swing.JFrame {
    ...
    public B() {
        ...
        try {
            ...
            modelo.addColumn("Tipo de documento que lleva: ");
            modelo.addColumn("Identificacion: ");
            modelo.addColumn("Nombre: ");
            modelo.addColumn("Fecha de Ingreso: ");
            modelo.addColumn("Hora de Ingreso: ");
            modelo.addColumn("A quien visita: ");
            modelo.addColumn("Motivo de su visita: ");
    ...
    private void jtUsuariosMouseClicked(java.awt.event.MouseEvent evt) {                                        
        ...
        try {
            ...
            while (rs.next()) {
                txtTipo.setText(rs.getString("Que tipo de documento tiene: "));
                ...
                txtVisita.setText(rs.getString("Nombre de la persona a la que visita: "));
                txtMotivo.setText(rs.getString("Motivo de visita: "));
